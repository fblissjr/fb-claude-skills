...
| The control-audit skill (census + adversarial live-fire over hooks, validators, reminders; joins postmortem) — designed, NOT started | [docs/internals/control_audit_design.md](docs/internals/control_audit_design.md) |
