...
// It used to be a literal in mcp-app-wrapper.tsx, which drifted two releases
// behind plugin.json while nothing noticed -- the host was told 1.1.0 by an app
// installs resolved as 1.1.2. plugin.json is what the version cascade bumps, so
