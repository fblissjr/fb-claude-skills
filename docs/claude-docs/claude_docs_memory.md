...
On this page
  ...
  * [What Claude remembers](https://code.claude.com/docs/en/memory#what-claude-remembers)
  * [Where auto memory is stored](https://code.claude.com/docs/en/memory#where-auto-memory-is-stored)
  * [Manage auto memory](https://code.claude.com/docs/en/memory#manage-auto-memory)
...
Yes
[Speed up responses with fast mode](https://code.claude.com/docs/en/fast-mode)[Customize status line](https://code.claude.com/docs/en/statusline)
Assistant
