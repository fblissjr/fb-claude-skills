...
---|---|---  
Enterprise | See [managed settings](https://code.claude.com/docs/en/permissions#managed-settings) | All users in your organization  
...
Skills can be distributed at different scopes depending on your audience:
  ...
  * **Managed** : Deploy organization-wide through [managed settings](https://code.claude.com/docs/en/permissions#managed-settings)
