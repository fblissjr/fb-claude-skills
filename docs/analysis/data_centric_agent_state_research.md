...
>
> Durable: the comparative landscape survey (MemGPT/Letta, LangSmith, Braintrust, OTel GenAI semconv, Mem0, Zep, Phoenix) and the DuckDB-vs-alternatives rationale — VISION.md asserts the conclusion but not the comparison.
