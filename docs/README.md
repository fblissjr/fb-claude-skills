...
| [path_privacy_consolidation.md](internals/path_privacy_consolidation.md) | Merging path-privacy and the owner's personal-data hook into one git-level gate (global dispatcher, external-push enforcement) — shelved 2026-09-24: the owner declined a machine-wide gate; settings-based protection instead |
