...
Machine-parseable best practices extracted from the Anthropic skills guide (PDF), official Claude Code docs, Agent Skills spec, and this repo's design principles (see `VISION.md`). Used by the quality skill and skill-maintainer CLI to validate skills and detect drift.
