...
description: >-
  Set up skill-maintainer in a repo — creates .skill-maintainer/ with config, state
  tracking, and the best-practices checklist, and installs the pre-commit hook. Use
  when the user says "init maintenance", "set up maintenance", "initialize
  skill-maintainer", or "add maintenance to this repo".
