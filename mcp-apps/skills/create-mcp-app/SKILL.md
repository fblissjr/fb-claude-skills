...
> **Offline references**: Core documentation is available locally in `mcp-apps/references/` (overview, patterns, testing, specification). For full working examples, clone the upstream repo as described below.
